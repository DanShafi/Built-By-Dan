            ...
            <Container>
                <Navbar style={{fontSize: 15}} expand="lg" className="nav-gap navbar-dark nav-style" >
                    <Navbar.Brand href="/" style={{fontSize: 15, fontWeight: "bold"}}>Built By Dan.</Navbar.Brand>
                        ...
                        <img src="https://images.vexels.com/media/users/3/143495/isolated/preview/6b80b9965b1ec4d47c31d7eccf8ce4b0-yellow-lightning-bolt-icon-by-vexels.png" alt="lightning-bolt" height="30px"/>
